            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '12px' }}>
              <thead>
                <tr style={{ background: '#1A1D2A' }}>
                  {['Nº NF','Tipo','Destinatário','CNPJ Dest.','Valor NF','Dt. Emissão','Valor Pago','Restante','Dt. Pagto','Imposto','Ajuste','Status',''].map((h, i) => (
                  ...
                  return (
                    <React.Fragment key={r.numero_nf}>
                      ...
                      <tr style={rowStyle}>
                        ...
                        <td style={tdBase({ textAlign: 'center', width: '30px', minWidth: '30px', whiteSpace: 'nowrap', fontSize: '10px' })}><span style={{ padding: '2px 6px', borderRadius: '8px', background: (r.tipo||'saida')==='entrada' ? 'rgba(251,191,36,0.15)' : 'rgba(52,211,153,0.15)', color: (r.tipo||'saida')==='entrada' ? '#FBBF24' : '#34D399', fontWeight: 600 }}>{(r.tipo||'saida')==='entrada' ? 'E' : 'S'}</span></td>
