                  ...
                  return (
                    <React.Fragment key={r.numero_nf}>
                      ...
                      <tr style={rowStyle}>
                        ...
                        <td style={tdBase({ textAlign: 'center', whiteSpace: 'nowrap', fontSize: '10px', padding: '8px 4px', width: '40px', maxWidth: '40px' })}><span style={{ borderRadius: '8px', padding: '1px 4px', background: (r.tipo||'saida')==='entrada' ? 'rgba(251,191,36,0.15)' : 'rgba(52,211,153,0.15)', color: (r.tipo||'saida')==='entrada' ? '#FBBF24' : '#34D399', fontWeight: 600 }}>{(r.tipo||'saida')==='entrada' ? 'E' : 'S'}</span></td>
