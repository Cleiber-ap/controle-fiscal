            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '12px', tableLayout: 'fixed' }}>
              <thead>
                <tr style={{ background: '#1A1D2A' }}>
                  ...
                  <th style={{ fontSize: '10px', fontWeight: 600, textTransform: 'uppercase' as const, letterSpacing: '1px', color: '#7B82A0', borderBottom: '1px solid #252836', whiteSpace: 'nowrap' as const, padding: '8px 4px', width: '28px', textAlign: 'center' as const }}>Tipo</th>
                  <th style={{ fontSize: '10px', fontWeight: 600, textTransform: 'uppercase' as const, letterSpacing: '1px', color: '#7B82A0', borderBottom: '1px solid #252836', whiteSpace: 'nowrap' as const, padding: '8px 12px', width: '160px' }}>Destinatário</th>
                  <th style={{ fontSize: '10px', fontWeight: 600, textTransform: 'uppercase' as const, letterSpacing: '1px', color: '#7B82A0', borderBottom: '1px solid #252836', whiteSpace: 'nowrap' as const, padding: '8px 12px', width: '130px' }}>CNPJ Dest.</th>
                  <th style={{ fontSize: '10px', fontWeight: 600, textTransform: 'uppercase' as const, letterSpacing: '1px', color: '#7B82A0', borderBottom: '1px solid #252836', whiteSpace: 'nowrap' as const, padding: '8px 12px', width: '100px', textAlign: 'right' as const }}>Valor NF</th>
                  <th style={{ fontSize: '10px', fontWeight: 600, textTransform: 'uppercase' as const, letterSpacing: '1px', color: '#7B82A0', borderBottom: '1px solid #252836', whiteSpace: 'nowrap' as const, padding: '8px 12px', width: '85px', textAlign: 'right' as const }}>Dt. Emissão</th>
                  <th style={{ fontSize: '10px', fontWeight: 600, textTransform: 'uppercase' as const, letterSpacing: '1px', color: '#7B82A0', borderBottom: '1px solid #252836', whiteSpace: 'nowrap' as const, padding: '8px 12px', width: '100px', textAlign: 'right' as const }}>Valor Pago</th>
                  <th style={{ fontSize: '10px', fontWeight: 600, textTransform: 'uppercase' as const, letterSpacing: '1px', color: '#7B82A0', borderBottom: '1px solid #252836', whiteSpace: 'nowrap' as const, padding: '8px 12px', width: '90px', textAlign: 'right' as const }}>Restante</th>
                  <th style={{ fontSize: '10px', fontWeight: 600, textTransform: 'uppercase' as const, letterSpacing: '1px', color: '#7B82A0', borderBottom: '1px solid #252836', whiteSpace: 'nowrap' as const, padding: '8px 12px', width: '85px', textAlign: 'right' as const }}>Dt. Pagto</th>
                  <th style={{ fontSize: '10px', fontWeight: 600, textTransform: 'uppercase' as const, letterSpacing: '1px', color: '#7B82A0', borderBottom: '1px solid #252836', whiteSpace: 'nowrap' as const, padding: '8px 12px', width: '90px', textAlign: 'right' as const }}>Imposto</th>
                  <th style={{ fontSize: '10px', fontWeight: 600, textTransform: 'uppercase' as const, letterSpacing: '1px', color: '#7B82A0', borderBottom: '1px solid #252836', whiteSpace: 'nowrap' as const, padding: '8px 12px', textAlign: 'center' as const }}>Ajuste</th>
                  <th style={{ fontSize: '10px', fontWeight: 600, textTransform: 'uppercase' as const, letterSpacing: '1px', color: '#7B82A0', borderBottom: '1px solid #252836', whiteSpace: 'nowrap' as const, padding: '8px 12px', width: '150px' }}>Status</th>
                  <th style={{ fontSize: '10px', fontWeight: 600, textTransform: 'uppercase' as const, letterSpacing: '1px', color: '#7B82A0', borderBottom: '1px solid #252836', whiteSpace: 'nowrap' as const, padding: '8px 12px', width: '50px' }}></th>
                </tr>
              </thead>
              <tbody>
                  ...
                  return (
                    <React.Fragment key={r.numero_nf}>
                      ...
                      <tr style={rowStyle}>
                        ...
                        <td style={tdBase({ textAlign: 'center', whiteSpace: 'nowrap', fontSize: '10px', padding: '8px 4px', width: '25px', maxWidth: '25px' })}><span style={{ borderRadius: '8px', padding: '1px 2px', background: (r.tipo||'saida')==='entrada' ? 'rgba(251,191,36,0.15)' : 'rgba(52,211,153,0.15)', color: (r.tipo||'saida')==='entrada' ? '#FBBF24' : '#34D399', fontWeight: 600 }}>{(r.tipo||'saida')==='entrada' ? 'E' : 'S'}</span></td>
                      ...
                      {mostrarProxima && !filtroMesPagto && (
                        <>
                          <tr key={r.numero_nf + '-prox'} style={{ background: 'rgba(248,113,113,0.03)', borderLeft: '3px solid #F87171' }}>
                            ...
                            <td style={tdSm()}></td>
                            <td style={tdSm({ color: '#7B82A0', fontSize: '11px', fontStyle: 'italic', whiteSpace: 'nowrap' })}>Pagamento parcial {lista.length + 1}</td>
                            <td style={tdSm()}></td>
                            <td style={tdSm()}></td>
