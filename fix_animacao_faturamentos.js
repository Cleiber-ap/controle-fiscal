const fs = require("fs");
const f = "C:/projetos/controle-fiscal/frontend/src/pages/Faturamentos/index.tsx";
...
// 2. Inserir componente ContadorAnimado antes de "export default function Faturamentos()"
const anchor2 = "export default function Faturamentos() {";
...
// 3. Trocar {fmtR(acumTotal)} pelo componente animado
const anchor3 = "<div style={{ fontSize: '30px', fontWeight: 700, ...mono, color: '#E8EAF0' }}>{fmtR(acumTotal)}</div>";
const idx3 = c.indexOf(anchor3);
if (idx3 === -1) { console.log("FALHOU: anchor3"); ok = false; }
else {
  c = c.replace(anchor3, "<div style={{ fontSize: '30px', fontWeight: 700, ...mono }}><ContadorAnimado valor={acumTotal} cor=\"#E8EAF0\" formatador={fmtR} /></div>");
  console.log("OK: Total Consolidado usa ContadorAnimado");
}
