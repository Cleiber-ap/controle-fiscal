...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:5173", "https://controle-fiscal-vdxk.vercel.app"], "https://controle-fiscal-wine.vercel.app", "https://*.vercel.app", "https://controle-fiscal-vdxk.vercel.app"],
