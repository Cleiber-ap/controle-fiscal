...
const anchor = "animation: 'giroLogo 20s linear infinite'";
const idx = c.indexOf(anchor);
if (idx === -1) { console.log("FALHOU: anchor"); ok = false; }
else {
  c = c.replace(anchor, "animation: 'giroLogo 60s linear infinite'");
  console.log("OK - giro agora ocorre a cada 60 segundos");
}
